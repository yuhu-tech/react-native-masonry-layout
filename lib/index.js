...
import { FlatList, ScrollView, View, ViewPropTypes, Image } from "react-native";
...
export default class Masonry extends React.Component {
  ...
  render() {
    return <ScrollView ref={(r) => {
      if (this.props?.getScrollViewRef) {
        this.props?.getScrollViewRef(r)
      }
    }} {...this.props} >
      {this.props.header}
      <View style={[{ flexDirection: "row" }, this.props.containerStyle]}>
        ...
        {this.state.columns.length === 0 && this.props?.img && (
